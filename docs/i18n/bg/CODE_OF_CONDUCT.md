# Български (bg) — Кодекс за поведение

**Languages:** [English](../../../CODE_OF_CONDUCT.md) · [Български](CODE_OF_CONDUCT.md) · [Всички езици](../../LANGUAGES.md)
...
Изграждаме open professional harassment-free community. Бъдете respectful, specific, constructive; critique code, accept corrections, help newcomers, protect sensitive data.

Неприемливи: harassment, threats, attacks, discrimination, doxxing, unwanted sexual attention, spam, deception, irresponsible vulnerability disclosure, authorship theft.
