# Български (bg) — Отворен код

**Languages:** [English](../../OPEN_SOURCE.md) · [Български](OPEN_SOURCE.md) · [Всички езици](../../LANGUAGES.md)
...
Единственият лиценз е Apache License 2.0 (SPDX: Apache-2.0): позволява private, commercial и open-source use, modification, distribution; изисква запазване на лиценз/attribution, маркиране на промените и дава explicit patent grant.

MIT е по-кратък, но няма същите подробни patent terms; проектът не е dual-licensed. Преди publish собственикът потвърждава права, липса на employer/client ownership, copied code, secrets, personal/customer data и лицензите на third-party материалите.

Проектът е независим, не е официален или endorsed от EK/EU/tax authority. Contributions следват Apache-2.0 §5 и CONTRIBUTING; няма отделен CLA. Това е operational summary, не индивидуален legal advice.
