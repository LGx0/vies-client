...
**Jazyky:** [English](../../../SUPPORT.md) · [Čeština](SUPPORT.md) · [Dokumentace](README.md)

> Informativní překlad; při rozporu platí anglický originál. Jediná závazná licence je [LICENSE](../../../LICENSE); překlad není licencí.

Pro reprodukovatelnou chybu použijte bug template, pro dotazy GitHub Discussions, pro zranitelnost [SECURITY.md](SECURITY.md). Komunitní podpora je best-effort bez garantované odezvy a není daňovým, právním ani účetním poradenstvím; za rozhodnutí odpovídá integrátor.

Dary jsou dobrovolné a nekupují prioritu, SLA, bezpečnostní výjimku ani governance právo. Ověřený funding URL spravuje `.github/FUNDING.yml`.

Projekt můžete podpořit přes [Buy Me a Coffee](https://buymeacoffee.com/lgx0). Dar je dobrovolný a nekupuje prioritu, SLA ani právo řídit projekt.
