# Ελληνικά (el) — Κώδικας δεοντολογίας

**Languages:** [English](../../../CODE_OF_CONDUCT.md) · [Ελληνικά](CODE_OF_CONDUCT.md) · [Όλες οι γλώσσες](../../LANGUAGES.md)
...
Δημιουργούμε μια ανοικτή, επαγγελματική κοινότητα χωρίς παρενόχληση. Να είστε σεβαστικοί, συγκεκριμένοι και εποικοδομητικοί· κρίνετε τον κώδικα, δεχτείτε διορθώσεις, βοηθήστε νέους συμμετέχοντες και προστατεύστε ευαίσθητα δεδομένα.

Μη αποδεκτά είναι η παρενόχληση, οι απειλές, οι προσωπικές επιθέσεις, η διάκριση, το doxxing, η ανεπιθύμητη σεξουαλική προσοχή, το spam, η εξαπάτηση, η ανεύθυνη γνωστοποίηση ευπάθειας και η ιδιοποίηση πατρότητας.

Report privately. Maintainers may warn, edit/remove content, temporary/permanent restrict participation. Applies to issues, PR, discussions, reviews, releases, public project representation.
