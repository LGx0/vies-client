# Polski (pl) — Kodeks postępowania

**Języki:** [English](../../../CODE_OF_CONDUCT.md) · [Polski](CODE_OF_CONDUCT.md) · [Dokumentacja](README.md)
...
Budujemy otwartą, profesjonalną społeczność bez nękania niezależnie od doświadczenia, pochodzenia, tożsamości, zdolności czy poglądu. Szanuj ludzi, bądź konkretny i konstruktywny; krytykuj kod, przyjmuj korekty, pomagaj nowym, chroń dane.

Niedopuszczalne: nękanie, groźby, ataki, dyskryminacja, doxxing, niechciana uwaga seksualna, spam, oszustwo, nieodpowiedzialne disclosure i przywłaszczenie autorstwa.

Incydenty zgłaszaj prywatnie. Maintainer może ostrzec, edytować/usunąć treść lub ograniczyć udział. Zasady obejmują issues, PR, discussions, reviews, releases i publiczne reprezentowanie projektu.
