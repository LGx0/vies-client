...
**Języki:** [English](../../../SUPPORT.md) · [Polski](SUPPORT.md) · [Dokumentacja](README.md)
...
Bug: template; pytania: GitHub Discussions; podatność: [SECURITY.md](SECURITY.md). Wsparcie społeczności jest best-effort bez terminu i nie stanowi porady podatkowej/prawnej/księgowej; integrator odpowiada za decyzje i compliance.

Darowizny są dobrowolne i nie kupują priorytetu, SLA, wyjątku bezpieczeństwa ani praw governance. URL kontroluje `.github/FUNDING.yml`.

Wesprzyj projekt przez [Buy Me a Coffee](https://buymeacoffee.com/lgx0). Darowizna jest dobrowolna i nie zapewnia priorytetu, SLA ani praw do zarządzania projektem.
