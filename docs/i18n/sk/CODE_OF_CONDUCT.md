# Slovenčina (sk) — Kódex správania

**Jazyky:** [English](../../../CODE_OF_CONDUCT.md) · [Slovenčina](CODE_OF_CONDUCT.md) · [Dokumentácia](README.md)

> Informatívny preklad; rozhoduje anglický originál. Jediná záväzná licencia je [LICENSE](../../../LICENSE); preklad nie je licenciou.

Budujeme otvorenú profesionálnu komunitu bez obťažovania. Rešpektujte ľudí, buďte konkrétni/konštruktívni, kritizujte kód, prijmite opravy, pomáhajte novým a chráňte sensitive dáta.

Zakázané: harassment, threats, attacks, discrimination, doxxing, unwanted sexual attention, spam, deception, irresponsible vulnerability disclosure, misrepresentation of authorship.

Incident hláste súkromne. Maintainers môžu warning, edit/remove content, temporary/permanent restriction. Platí pre issues, PR, discussions, reviews, releases a public project communication.
