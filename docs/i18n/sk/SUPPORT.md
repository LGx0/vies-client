# Slovenčina (sk) — Podpora

**Jazyky:** [English](../../../SUPPORT.md) · [Slovenčina](SUPPORT.md) · [Dokumentácia](README.md)

> Informatívny preklad; rozhoduje anglický originál. Jediná záväzná licencia je [LICENSE](../../../LICENSE); preklad nie je licenciou.

Pre reprodukovateľnú chybu použite bug template, pre otázky GitHub Discussions a pre zraniteľnosti [SECURITY.md](SECURITY.md). Komunitná podpora je poskytovaná podľa možností bez garantovaného času odpovede a nie je daňovým, právnym ani účtovným poradenstvom; integrátor zodpovedá za rozhodnutia.

Dary sú dobrovoľné a nekupujú prioritu, SLA, bezpečnostnú výnimku ani právo riadiť projekt. Overenú URL spravuje `.github/FUNDING.yml`.

Projekt môžete podporiť cez [Buy Me a Coffee](https://buymeacoffee.com/lgx0). Dar je dobrovoľný a nekupuje prioritu, SLA ani právo riadiť projekt.
